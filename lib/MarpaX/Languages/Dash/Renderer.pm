package MarpaX::Languages::Dash::Renderer;
...
See L<MarpaX::Languages::Dash/Synopsis>.

In particular, L<MarpaX::Languages::Dash/DASH> describes DASH, the Graphviz-like graph
...
This module is the default rendering engine for L<MarpaX::Languages::Dash>.

It provides a L<GraphViz2>-based renderer for DASH, as parsed by L<MarpaX::Languages::Dash>.

For more details, see L<MarpaX::Languages::Dash/Description>.
...
C<new()> is called as C<< my($parser) = MarpaX::Languages::Dash::Renderer -> new(k1 => v1, k2 => v2, ...) >>.

It returns a new object of type C<MarpaX::Languages::Dash::Renderer>.
...
The value for I<rankdir> is passed to L<MarpaX::Languages::Dash::Renderer>.
