package MarpaX::Languages::Dash::Filer;
...
Returns a hash of files' basenames and their names. Used by L<MarpaX::Languages::Dash::Utils>.
...
C<new()> is called as C<< my($obj) = MarpaX::Languages::Dash::Filer -> new(k1 => v1, k2 => v2, ...) >>.
